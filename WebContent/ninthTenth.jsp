		...
		<div id="page_content">
			...
			<div class="right_section">
				<div class="common_content">
					<h2>Products</h2>
<h3>Top 9 and 10 hottest Argos products</h3>
					<table class="t2" style="width: 100" cellpadding="5">
						<tr>

							<td align="center" valign="center" style="width: 50%"><p
									id="tooltip1">
									<a href="<%out.println(ext1.items[8].urlProduct);%>>"> <img
										border="0" alt="HUKD"
										src="<%out.println(ext1.items[8].urlImage);%>" width="200px"
										height="200"> <span> <%
 ...
 %>
 	...
 	out.println(ext1.items[8].name);
 %> <br /></td>

							<td align="center" valign="center" style="width: 50%"><p
									id="tooltip1">
									<a href="<%out.println(ext1.items[9].urlProduct);%>>"> <img
										border="0" alt="HUKD"
										src="<%out.println(ext1.items[9].urlImage);%>" width="200px"
										height="200"><span> <%
 	out.println("<strong>Description: </strong><br />"
 			+ ext1.items[9].des);
 %>
 	...
 	out.println(ext1.items[9].name);
 %> <br /></td>
						<tr align="center" valign="center">
							<td>
								<%
									out.println("\u00A3" + ext1.items[8].price + "<br />");
								%>
							</td>
							<td>
								<%
									out.println("\u00A3" + ext1.items[9].price + "<br />");
								%>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println(ext1.items[8].temperature + "&#8451;<br />");
								%>
							</td>
							<td>
								<%
									out.println(ext1.items[9].temperature + "&#8451;<br />");
								%>
							</td>
						</tr>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[8].urlDeal
											+ ">View on HUKD.com</a>");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[9].urlDeal
											+ ">View on HUKD.com</a>");
								%>
							</td>
						</tr>
						<tr align="center" valign="center">
							<td>
								<%
								out.println("<a href=" +ext1.items[8].walPro+ ">\u00A3"
										+ ext1.items[8].differentPrice + "</a> on Walmart!*");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" +ext1.items[9].walPro+ ">\u00A3"
											+ ext1.items[9].differentPrice + "</a> on Walmart!*");
								%>
							</td>
						</tr>
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[8].urlProduct
											+ ">Purchase this product from Argos</a>");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[9].urlProduct
											+ ">Purchase this product from Argos</a>");
								%>
							</td>
						</tr>
