		...
		<div id="page_content">
			...
			<div class="right_section">
				<div class="common_content">
					<h2>Products</h2>
<h3>Top 7 and 8 hottest Argos products</h3>
					<table class="t2" style="width: 100" cellpadding="5">
						<tr>

							<td align="center" valign="center" style="width: 50%"><p
									id="tooltip1">
									<a href="<%out.println(ext1.items[6].urlProduct);%>>"> <img
										border="0" alt="HUKD"
										src="<%out.println(ext1.items[6].urlImage);%>" width="200px"
										height="200"> <span> <%
 ...
 %>
 	...
 	out.println(ext1.items[6].name);
 %> <br /></td>

							<td align="center" valign="center" style="width: 50%"><p
									id="tooltip1">
									<a href="<%out.println(ext1.items[7].urlProduct);%>>"> <img
										border="0" alt="HUKD"
										src="<%out.println(ext1.items[7].urlImage);%>" width="200px"
										height="200"><span> <%
 	out.println("<strong>Description: </strong><br />"
 			+ ext1.items[7].des);
 %>
 	...
 	out.println(ext1.items[7].name);
 %> <br /></td>
						<tr align="center" valign="center">
							<td>
								<%
									out.println("\u00A3" + ext1.items[6].price + "<br />");
								%>
							</td>
							<td>
								<%
									out.println("\u00A3" + ext1.items[7].price + "<br />");
								%>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println(ext1.items[6].temperature + "&#8451;<br />");
								%>
							</td>
							<td>
								<%
									out.println(ext1.items[7].temperature + "&#8451;<br />");
								%>
							</td>
						</tr>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[6].urlDeal
											+ ">View on HUKD.com</a>");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[7].urlDeal
											+ ">View on HUKD.com</a>");
								%>
							</td>
						</tr>
						<tr align="center" valign="center">
							<td>
								<%
								out.println("<a href=" +ext1.items[6].walPro+ ">\u00A3"
										+ ext1.items[6].differentPrice + "</a> on Walmart!*");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" +ext1.items[7].walPro+ ">\u00A3"
											+ ext1.items[7].differentPrice + "</a> on Walmart!*");
								%>
							</td>
						</tr>
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[6].urlProduct
											+ ">Purchase this product from Argos</a>");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[7].urlProduct
											+ ">Purchase this product from Argos</a>");
								%>
							</td>
						</tr>
