...
<body>
		...
		<div id="page_content">
			...
			<div class="right_section">
				<div class="common_content">
					<h2>Products</h2>
					<h3>Top 3 and 4 hottest Argos products</h3>
					<table class="t2" style="width: 100" cellpadding="5">
						<tr>

							<td align="center" valign="center" style="width: 50%"><p
									id="tooltip1">
									<a href="<%out.println(ext1.items[2].urlProduct);%>>"> <img
										border="0" alt="HUKD"
										src="<%out.println(ext1.items[2].urlImage);%>" width="200px"
										height="200"> <span> <%
 ...
 %>
 	...
 	out.println(ext1.items[2].name);
 %> <br /></td>

							<td align="center" valign="center" style="width: 50%"><p
									id="tooltip1">
									<a href="<%out.println(ext1.items[3].urlProduct);%>>"> <img
										border="0" alt="HUKD"
										src="<%out.println(ext1.items[3].urlImage);%>" width="200px"
										height="200"><span> <%
 	out.println("<strong>Description: </strong><br />"
 			+ ext1.items[3].des);
 %>
 	...
 	out.println(ext1.items[3].name);
 %> <br /></td>
						<tr align="center" valign="center">
							<td>
								<%
									out.println("\u00A3" + ext1.items[2].price + "<br />");
								%>
							</td>
							<td>
								<%
									out.println("\u00A3" + ext1.items[3].price + "<br />");
								%>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println(ext1.items[2].temperature + "&#8451;<br />");
								%>
							</td>
							<td>
								<%
									out.println(ext1.items[3].temperature + "&#8451;<br />");
								%>
							</td>
						</tr>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[2].urlDeal
											+ ">View on HUKD.com</a>");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[3].urlDeal
											+ ">View on HUKD.com</a>");
								%>
							</td>
						</tr>
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[2].walPro + ">\u00A3"
											+ ext1.items[2].differentPrice + "</a> on Walmart!*");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[3].walPro + ">\u00A3"
											+ ext1.items[3].differentPrice + "</a> on Walmart!*");
								%>
							</td>
						</tr>
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[2].urlProduct
											+ ">Purchase this product from Argos</a>");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[3].urlProduct
											+ ">Purchase this product from Argos</a>");
								%>
							</td>
						</tr>
