...
<body>
					...
					<table class="t2" style="width: 100">
						<tr>
							...
							<td align="center" valign="center" style="width: 50%"><p
									id="tooltip1">
									<a href="<%out.println(ext1.items[4].urlProduct);%>>"> <img
										border="0" alt="HUKD"
										src="<%out.println(ext1.items[4].urlImage);%>" width="200px"
										height="200"> <span> <%
 ...
 %>
 	...
 	out.println(ext1.items[4].name);
 %> <br /></td>

							<td align="center" valign="center" style="width: 50%"><p
									id="tooltip1">
									<a href="<%out.println(ext1.items[5].urlProduct);%>>"> <img
										border="0" alt="HUKD"
										src="<%out.println(ext1.items[5].urlImage);%>" width="200px"
										height="200"><span> <%
 	out.println("<strong>Description: </strong><br />"
 			+ ext1.items[5].des);
 %>
 	...
 	out.println(ext1.items[5].name);
 %> <br /></td>
						<tr align="center" valign="center">
							<td>
								<%
									out.println("\u00A3" + ext1.items[4].price + "<br />");
								%>
							</td>
							<td>
								<%
									out.println("\u00A3" + ext1.items[5].price + "<br />");
								%>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println(ext1.items[4].temperature + "&#8451;<br />");
								%>
							</td>
							<td>
								<%
									out.println(ext1.items[5].temperature + "&#8451;<br />");
								%>
							</td>
						</tr>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[4].urlDeal
											+ ">View on HUKD.com</a>");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[5].urlDeal
											+ ">View on HUKD.com</a>");
								%>
							</td>
						</tr>
						...
						<tr align="center" valign="center">
							<td>
								<%
									out.println("<a href=" + ext1.items[4].urlProduct
											+ ">Purchase this product from Argos</a>");
								%>
							</td>
							<td>
								<%
									out.println("<a href=" + ext1.items[5].urlProduct
											+ ">Purchase this product from Argos</a>");
								%>
							</td>
						</tr>
